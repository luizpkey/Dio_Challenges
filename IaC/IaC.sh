...
echo "Excluindo Usuários/Remove users"
sudo userdel carlos 
sudo userdel maria
sudo userdel joao
sudo userdel debora
...
echo "Criando Usuários/Create users"
...
echo "Criando diretórios/Create folders"
sudo mkdir /publico /adm /ven /sec

echo "Alterando privilégios/Privileges management"
